defmodule MomogogoWeb.PostLiveTest do
  ...
  @create_attrs %{activity: "some activity", date: "some date", duration: "some duration", steps: 42, username: "some username"}
