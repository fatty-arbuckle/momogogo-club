defmodule Momogogo.Activity do
  ...
  @conversion_table %{
    ...
    "Bicycling, 10 mph easy" => %{ rate: 133, icon: "fa-biking" },
    "Bicycling, 13 mph moderate" => %{ rate: 178, icon: "fa-biking" },
    "Bicycling, 15 mph vigorous" => %{ rate: 222, icon: "fa-biking" },
    ...
    "Spinning class" => %{ rate: 240, icon: "fa-biking" },
